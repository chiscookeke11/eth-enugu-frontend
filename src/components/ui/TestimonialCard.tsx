...
const Dot = () => {
  return (
    <span className="bg-[#666666] size-[4.46px] rounded-full shrink-0 "></span>
  );
};
    ...
    >
      <div className="w-full flex items-center justify-start gap-[16.73px] ">
        ...
        <div className="space-y-[5.58px] ">
          <h3 className="text-[#000000] text-lg! md:text-[27px]! font-extrabold ">
            {" "}
            {testimonial.name}{" "}
          </h3>
          <h4 className="text-[#666666] text-base! md:text-lg! ">
            {testimonial.handle}
          </h4>
        </div>
      </div>
